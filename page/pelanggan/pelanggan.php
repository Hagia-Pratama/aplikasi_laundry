                ...
                <tr>
                  ...
                  <td>
                    <a href="?page=pelanggan&aksi=ubah&id=<?php echo $data['kode_pelanggan'];?>" class="btn btn-success" title=""><i class="fa fa-edit"> </i> ubah</a>
                     <a onclick="return confirm('Apakah anda ingin menghapus data ini')"href="?page=pelanggan&aksi=hapus&id=<?php echo $data['kode_pelanggan'];?>" class="btn btn-danger" title=""><i class="fa fa-trash"> </i> hapus</a>
                  </td>
                </tr>
                <?php } ?>
              </tbody>
